...
export function voteUp(question) {
  return {
    ...
    promise: (client) => client.put(`/api/v1/question/name/${question.get('shortId')}/${question.get('slug')}/vote/up`),
    data: {
...
export function voteDown(question) {
  return {
    ...
    promise: (client) => client.put(`/api/v1/question/name/${question.get('shortId')}/${question.get('slug')}/vote/down`),
    data: {
      questionShortId: question.get('shortId')
    }
  };
