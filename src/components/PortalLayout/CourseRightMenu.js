...
export default class CourseRightMenu extends Component {
  ...
  render() {
    const {courseName, course} = this.props;
    return (
      <div className="panel panel-flat">
        ...
        <div className="list-group no-border no-padding-top">
          <Link activeClassName="active" to={'/author/course/' + courseName + '/goals'} className="list-group-item">
            <i className="icon-user"></i> Goals
          </Link>
          <Link activeClassName="active" to={'/author/course/' + courseName + '/accounting'}
                className="list-group-item">
            <i className="icon-cash3"></i> Accounting
          </Link>
          <Link activeClassName="active" to={'/author/course/' + courseName + '/lesson/list'}
                className="list-group-item">
